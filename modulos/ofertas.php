<?php
global $mysqli;
    $strsql = "SELECT idproducto, nombre_producto, descripcion, precio, cantidad, url_imagen FROM productos where cantidad > 20";
        ...
        if ($stmt->num_rows > 0){
           ...
           while ($stmt->fetch()){
            ...
            <div class="col l6 m6 s12">
                ...
                <h5>Precio Normal: <b><?php echo "L ".number_format($precio, 2) ?></b></h5>
                <h5>Precio de Descuento: <b><?php $oferta=$precio-($precio*0.15); echo "L ".number_format ($oferta, 2) ?></b></h5>
